...
type Store interface {
	...
	GetIssues(ctx context.Context, filters *IssueFilters, after *string, before *string, first *int64, last *int64, sortBy IssueSortBy, sortOrder *string) ([]*Issue, bool, bool, string, string, error)
