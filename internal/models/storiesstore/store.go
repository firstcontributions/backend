...
type Store interface {
	...
	GetComments(ctx context.Context, filters *CommentFilters, after *string, before *string, first *int64, last *int64, sortBy *string, sortOrder *string) ([]*Comment, bool, bool, string, string, error)
	...
	GetReactions(ctx context.Context, filters *ReactionFilters, after *string, before *string, first *int64, last *int64, sortBy *string, sortOrder *string) ([]*Reaction, bool, bool, string, string, error)
