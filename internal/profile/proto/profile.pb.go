...
type Profile struct {
	...
	CursorCheckPoint *CursorCheckPoints     `protobuf:"bytes,11,opt,name=cursor_check_point,json=cursorCheckPoint,proto3" json:"cursor_check_point,omitempty"`
}
...
func (x *Profile) GetCursorCheckPoint() *CursorCheckPoints {
	if x != nil {
		return x.CursorCheckPoint
	}
	return nil
}
...
var file_api_profile_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x06, 0x45, 0x78, 0x70, 0x69, 0x72, 0x79, 0x22, 0xba,
	...
	0x6e, 0x12, 0x48, 0x0a, 0x12, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x5f, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x52, 0x10, 0x63, 0x75, 0x72, 0x73, 0x6f,
	0x72, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x2b, 0x0a, 0x11, 0x47,
	...
	0x52, 0x06, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x32, 0x85, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x6f,
	0x66, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x0a, 0x47,
	...
	0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x0d, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x10, 0x2e, 0x70, 0x72, 0x6f,
	0x66, 0x69, 0x6c, 0x65, 0x2e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x1a, 0x10, 0x2e, 0x70,
	0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x00,
	0x42, 0x18, 0x5a, 0x16, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f,
...
var file_api_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_api_profile_proto_depIdxs = []int32{
	5, // 0: profile.Badge.assigned_on:type_name -> google.protobuf.Timestamp
	5, // 1: profile.Token.Expiry:type_name -> google.protobuf.Timestamp
	0, // 2: profile.Profile.badges:type_name -> profile.Badge
	5, // 3: profile.Profile.date_updated:type_name -> google.protobuf.Timestamp
	5, // 4: profile.Profile.date_created:type_name -> google.protobuf.Timestamp
	2, // 5: profile.Profile.github_token:type_name -> profile.Token
	1, // 6: profile.Profile.cursor_check_point:type_name -> profile.CursorCheckPoints
	...
	3, // 9: profile.ProfileService.GetProfile:output_type -> profile.Profile
	3, // 10: profile.ProfileService.CreateProfile:output_type -> profile.Profile
